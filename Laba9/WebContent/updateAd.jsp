...
<c:choose>
	<c:when test="${param.id==null || param.id==0}">
		...
		<c:set var="title" scope="page" value="Creat" />
	</c:when>
	<c:otherwise>
	...
	<my:layout1Column>
		...
		<form action="/ad/doUpdateAd.jsp" method="post">
			...
			<table><%-- body="0" cellspacing="0" cellpadding="10" width="90%">--%>
				...
				<tr>
					<td>&nbsp;</td>
					<td><input type="submit" value="Save"> <%-- При нажатии на кнопку "Отменить" возвращаемся на страницу кабинета --%> <input type="button"
						value="Сancel"
